...
//! ajazz-macos/`. macOS's iCloud Drive daemon handles the actual
...
//! `~/Library/Mobile Documents/iCloud~io~github~wsclx~ajazz-macos/`,
...
//! required, the user sees an obvious `ajazz-macos/` folder in
...
/// Picked to be self-explanatory in Finder ("ajazz-macos") rather
/// than a reverse-DNS bundle ID.
const SYNC_SUBDIR: &str = "ajazz-macos";
