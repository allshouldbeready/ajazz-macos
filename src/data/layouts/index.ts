 ...
 *
 * Milestone one intentionally exposes only the ANSI layout matching the
 * supplied official installer and test keyboard. Other imported definitions
 * remain available for later hardware-verified releases.
 *
 ...
 */
export const LAYOUTS: Partial<Record<LayoutId, KeyboardLayout>> = { ansi: ANSI_LAYOUT };

/** The layout the app uses unless / until the user picks a different one. */
export const DEFAULT_LAYOUT_ID: LayoutId = "ansi";
