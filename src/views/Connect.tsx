      ...
      {bluetoothOnly && (
        <div className="mb-6 rounded-lg border border-warn/50 bg-warn/10 px-4 py-3">
          ...
          <p className="mt-1 text-sm text-fg-2">
            Bluetooth does not expose the AK820 Pro configuration channel. Connect
            the keyboard directly with a USB-C data cable, switch it to wired mode,
            then choose Re-probe. Saved settings remain available when you return to Bluetooth.
          </p>
        </div>
      )}
