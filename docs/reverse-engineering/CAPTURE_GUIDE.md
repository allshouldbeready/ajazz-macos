...
Then either:
- Open a [Protocol Finding issue](https://github.com/allshouldbeready/ak820-pro-macos/issues/new?template=protocol_finding.yml) describing what you captured, OR
