...
`AJAZZ macOS` talks to one USB-HID device via `hidapi`. Concretely:
...
**please open a private security advisory** at <https://github.com/allshouldbeready/ajazz-macos/security/advisories/new>.
